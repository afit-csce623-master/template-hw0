...
- When you open the [notebook file](https://github.com/afit-csce623-master/template-hw/blob/main/hw.ipynb), you'll see a static file. You have several options to interact with the notebook.
